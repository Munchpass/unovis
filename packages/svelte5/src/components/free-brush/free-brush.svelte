<script lang="ts">
  ...
  let prevConfig = $state<FreeBrushConfigInterface<Datum> | undefined>(undefined)
  const config = $derived({ ...props })

  // component declaration
  let component = $state<FreeBrush<Datum> | undefined>(undefined)
  ...
  // component accessor
  function getComponent (): FreeBrush<Datum> { return component }
